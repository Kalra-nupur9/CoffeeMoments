...
function page() {
  return (
    <>
      <div className=" bg-[#421A00] w-screen h-auto flex  flex-col items-center py-10 z-0">
       

        <h1 className="text-center text-8xl text-[#854e28] pb-10 z-10">Foods</h1>
        <div className=" bg-[#854e28] w-5/6 z-10">
