...
function page() {
  return (
    <>
      <div className="bg-[#ffffff] w-screen h-auto flex  flex-col items-center py-10 sm:py-1 md:py-1">
      
        <h1 className="text-center text-8xl text-[#854e28] pb-10 flex items-center" ><SiBuymeacoffee />Coffees <SiBuymeacoffee /></h1>
        <div className=" bg-[#F5E1C8] w-5/6 ">
          <div className="grid grid-flow-col grid-rows-5 justify-center  items-center p-24 gap-5">
            <div className=" relative flex justify-center items-center flex-col py-5 bg-white border border-orange-950 rounded-3xl hover:shadow-2xl">
              <img
                src="/images/Home/Additional_details.jpg"
                alt=""
                className="size-[70%] rounded-tl-2xl rounded-br-2xl"
              /> 
              <h2 className="text-4xl text-center">Coffee Name </h2>
              {/* veg Sign */}
